...
<div id="wrapper">
	<div id="page" class="container">
		<div id="content">
            ...
            <!-- forelse => same as for each but includes an if statement -->
            <!-- If we have articles... then iterate over them and display this -->
            @forelse ($articles as $article)
                ...
                <!-- empty tag => if there are no articles... -->
                <!-- needs the tag to exist (i.e. tag exists but not assocuated with any articles yet) -->
                @empty 
                    <p>No relavent articles yet</p>
            @endforelse
